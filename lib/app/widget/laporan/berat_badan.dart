        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  double selectedBerat = controller.beratBadanSaatIni.value;
                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        ...
                        content: ScrollPickerDesimalHorizontal(
                          min: 30.0,
                          max: 150.0,
                          interval: 0.1,
                          selectedValue: selectedBerat,
                          onChanged: (value) {
                            selectedBerat = value;
                          },
                        ),
                        actions: [
                          ...
                          TextButton(
                            ...
                            onPressed: () async {
                              await controller.updateBeratDanRiwayat(
                                selectedBerat,
                              );
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  height: 150,
                  child:
                      controller.riwayatBerat.isEmpty
                            ...
                            LineChartData(
                                ...
                                bottomTitles: AxisTitles(
                                  sideTitles: SideTitles(
                                    ...
                                    getTitlesWidget: (value, meta) {
                                      ...
                                      if (index >=
                                          controller.riwayatBerat.length)
                                        return const SizedBox();

                                      final tanggalString =
                                          controller
                                              .riwayatBerat[index]['tanggal'];
                                      final tanggal = DateTime.tryParse(
                                        tanggalString,
                                      );
                                      return Text(
                                        tanggal != null
                                            ? "${tanggal.month.toString().padLeft(2, '0')}-${tanggal.day.toString().padLeft(2, '0')}"
                                            : "",
                              ...
                              lineBarsData: [
                                LineChartBarData(
                                  isCurved: true,
                                  spots:
                                      controller.riwayatBerat
                                          .asMap()
                                          .entries
                                          .map((e) {
                                            final berat =
                                                (e.value['berat'] as num?)
                                                    ?.toDouble() ??
                                                0.0;
                                            return FlSpot(
                                              e.key.toDouble(),
